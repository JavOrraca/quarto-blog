...
description: "The R6 package, among others, brings forth the elegance of object-oriented programming (OOP) to a traditionally 'stats first' language. That said, do you need to know OOP to be a successful data scientist? No. Well, probably not!"
date: 11-22-2023
categories:
  - r6
  - tidyverse
...
![Javier, exploring whether or not data scientists need to know OOP](images/charlie.jpg){.preview-image}

# OOP with R

::: columns
::: {.column width="70%"}
The [R6 package](https://r6.r-lib.org/) brings forth the elegance of object-oriented programming (OOP) to a traditionally 'stats first' language. The [Tidy Wizard](https://chat.openai.com/g/g-QvPl8z04e-tidy-wizard), a barely-configured GPT variant that I crafted specializing in the R language, has the following to say about R6:
