...
NOTE: For the purposes of GitHub Actions and the config YAML file covered in Step 3, this file lives in the following path on my GitHub repo: `~/.github/workflows/main.yml`
