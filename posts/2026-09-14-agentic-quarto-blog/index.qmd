...
If you want to copy this shipping loop without starting from a blank repo, start from my [Quarto Grok Bot](https://x.ai/bot/05wMUj_-QOR1l3f2bbXxA){target="_blank"} public template. It is built for the same pattern: draft a post, open a PR via a coding agent, let Actions render, then publish the already-rendered `_site` to Netlify.
...
- [Quarto Grok Bot template](https://x.ai/bot/05wMUj_-QOR1l3f2bbXxA){target="_blank"} - a shareable starting point for the agentic Quarto shipping loop
