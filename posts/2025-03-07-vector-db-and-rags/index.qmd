---
title: "Vector DB + RAG Maker Tool"
...
If you're interested in building your own knowledge base from technical documentation, I've released a new project on GitHub that might be exactly what you or your enterprise need. My Vector DB and RAG Maker provides a simple yet powerful way to process, store, and query documentation (_in my example use case, recent R documentation and tutorials_) using vector embeddings and Retrieval-Augmented Generation (or "RAG").
...
[→ View the Vector DB and RAG Maker on GitHub](https://github.com/JavOrraca/Vector-DB-and-RAG-Maker)
